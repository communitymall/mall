<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-input v-model="listQuery.merchantName" clearable class="filter-item" style="width: 200px;" placeholder="请输入商户名称"/>
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      <el-table-column align="center" width="100px" label="商户ID" prop="id" sortable/>
      I
